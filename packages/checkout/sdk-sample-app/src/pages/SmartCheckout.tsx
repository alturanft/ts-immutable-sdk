...
export default function SmartCheckout() {
  ...
  return (
    <div>
      ...
      <Body>Smart checkout flows such as buy, sell and cancel.</Body>
      ...
      <Listings checkout={checkout} provider={provider} />
      ...
      <Buy checkout={checkout} provider={provider} />
      ...
      <Cancel checkout={checkout} provider={provider} />
      ...
      <Sell checkout={checkout} provider={provider} />
      ...
      <SmartCheckoutForm checkout={checkout} provider={provider} />
    </div>
  );
}

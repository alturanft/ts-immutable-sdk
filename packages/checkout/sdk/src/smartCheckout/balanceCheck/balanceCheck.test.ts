...
describe("balanceCheck", () => {
  ...
  describe("when NATIVE tokens are required", () => {
    it("should return sufficient if balance is sufficient", async () => {
      ...
      const { sufficient } = await balanceCheck(
        config,
        mockProvider,
        "0xADDRESS",
        itemRequirements
  ...
  describe("when no balances returned", () => {
    it("should aggregate balance requirements", async () => {
      ...
      expect(balanceRequirements).toEqual(
  ...
  describe("when multiple tokens are required", () => {
    it("should return sufficient if all balances are sufficient", async () => {
      ...
      const results = await balanceCheck(
        config,
        mockProvider,
        "0xADDRESS",
        itemRequirements
    ...
    it("should aggregate balance requirements", async () => {
      ...
      expect(result.balanceRequirements).toEqual(
        expect.arrayContaining([
          {
            current: {
              type: ItemType.NATIVE,
  ...
  describe("when requesting a cache reset", () => {
    ...
    it("should call getAllBalances with forceFetch = false when flag false or not provided", async () => {
      ...
      expect(getAllBalances as jest.Mock).toHaveBeenCalledWith(
        config,
        mockProvider,
        "0xADDRESS",
        expect.anything(),
      ...
      expect(getAllBalances as jest.Mock).toHaveBeenLastCalledWith(
        config,
        mockProvider,
        "0xADDRESS",
        expect.anything(),

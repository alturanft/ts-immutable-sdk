...
export function addAccountsChangedListener(
  web3Provider: Web3Provider,
  handleAccountsChanged: (e: any) => void
) {
  (web3Provider.provider as any).on(
...
export function removeAccountsChangedListener(
  ...
  (web3Provider.provider as any).removeListener(
    ProviderEvent.ACCOUNTS_CHANGED,
    handleAccountsChanged
  );
}

export function addChainChangedListener(
  web3Provider: Web3Provider,
  handleChainChanged: (e: any) => void
) {
  (web3Provider.provider as any).on(
